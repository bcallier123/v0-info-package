...
export default function HomePage() {
  return (
    <main className="min-h-screen">
      ...
      {/* Final CTA */}
      <section className="py-20 lg:py-28 bg-[#C9A227] relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#C9A227] via-yellow-500 to-[#C9A227]" />
        <div className="container mx-auto px-6 lg:px-12 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-black tracking-tight text-[#1a0a2e] mb-4 text-balance">
            READY TO BEGIN YOUR LEGACY?
          </h2>
          <p className="text-lg text-[#1a0a2e]/70 max-w-xl mx-auto mb-10 leading-relaxed">
            Your journey starts with one step. Let us guide you from discovery to career success.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="text-lg px-12 py-7 font-black bg-[#1a0a2e] text-white hover:bg-[#2d1b4e] shadow-xl"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-12 py-7 font-bold border-[#1a0a2e]/30 text-[#1a0a2e] hover:bg-[#1a0a2e]/10"
              asChild
            >
