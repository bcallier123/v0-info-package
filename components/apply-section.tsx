    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 text-balance">Ready to Apply?</h2>
          <p className="text-lg md:text-xl lg:text-2xl text-primary-foreground/95 max-w-3xl mx-auto text-pretty font-semibold">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur overflow-hidden">
            <CardHeader className="text-center pb-8 bg-gradient-to-br from-primary/5 to-secondary/5 px-6">
              <Badge className="mx-auto mb-4 bg-primary text-primary-foreground font-bold text-base px-6 py-2 shadow-lg">
                Simple 3-Step Process
              </Badge>
              <CardTitle className="text-3xl md:text-4xl lg:text-5xl font-black text-balance">Become a Golden Bear</CardTitle>
              <CardDescription className="text-base lg:text-lg mt-3 font-semibold">
            ...
            <CardContent className="p-6 md:p-8 lg:p-12">
              <div className="space-y-8">
                ...
                <div className="relative">
                  <div className="flex flex-col md:flex-row items-start gap-6 p-6 lg:p-8 rounded-2xl bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/30 hover:border-primary/50 transition-all group shadow-lg hover:shadow-xl">
                    <div className="relative flex-shrink-0">
                      <div className="w-16 lg:w-20 h-16 lg:h-20 rounded-2xl bg-primary text-white flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform">
                        <span className="text-3xl lg:text-4xl font-black">1</span>
                      </div>
                      <div className="absolute -bottom-2 -right-2 w-8 lg:w-10 h-8 lg:h-10 rounded-xl bg-secondary/80 flex items-center justify-center">
                        <Icons.fileText className="w-4 lg:w-5 h-4 lg:h-5 text-white" />
                      </div>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-black text-2xl lg:text-3xl mb-3 text-primary">Apply Online</h3>
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        <Button size="lg" className="font-bold shadow-lg w-auto text-base py-6" asChild>
                          <a href="https://myexperience.miles.edu" target="_blank" rel="noopener noreferrer">
                            <Icons.graduationCap className="w-5 h-5 mr-2" />
                            Start Application
                          </a>
                        </Button>
                        <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground font-semibold px-4 py-3 bg-white/80 rounded-lg border border-primary/20">
                ...
                <div className="relative">
                  <div className="flex flex-col md:flex-row items-start gap-6 p-6 lg:p-8 rounded-2xl bg-gradient-to-br from-secondary/10 to-secondary/5 border-2 border-secondary/30 hover:border-secondary/50 transition-all group shadow-lg hover:shadow-xl">
                    <div className="relative flex-shrink-0">
                      <div className="w-16 lg:w-20 h-16 lg:h-20 rounded-2xl bg-secondary text-white flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform">
                        <span className="text-3xl lg:text-4xl font-black">2</span>
                      </div>
                      <div className="absolute -bottom-2 -right-2 w-8 lg:w-10 h-8 lg:h-10 rounded-xl bg-accent/80 flex items-center justify-center">
                        <Icons.book className="w-4 lg:w-5 h-4 lg:h-5 text-white" />
                      </div>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-black text-2xl lg:text-3xl mb-3 text-secondary">Submit Your Documents</h3>
                      <p className="text-base text-muted-foreground leading-relaxed mb-4 font-medium">
