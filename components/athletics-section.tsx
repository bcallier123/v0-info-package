...
export function AthleticsSection() {
  ...
  return (
    <section
      id="athletics"
      className="py-24 lg:py-32 bg-gradient-to-br from-[#1a0a2e] via-[#2d1b4e] to-[#1a0a2e] relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 lg:mb-20">
          <div className="inline-flex items-center gap-3 bg-secondary/20 px-8 py-4 mb-8 border border-secondary/40">
            ...
            <span className="text-base font-black text-secondary uppercase tracking-wide">
        ...
        <div className="mb-16 lg:mb-20 max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
            <img
              ...
              loading="lazy"
              className="w-full h-80 lg:h-96 object-cover shadow-2xl hover:-translate-y-2 transition-all duration-500 border-4 border-white/10 hover:border-secondary/50"
            />
            <img
            ...
            <img
              ...
              loading="lazy"
              className="w-full h-80 lg:h-96 object-cover shadow-2xl hover:-translate-y-2 transition-all duration-500 col-span-2 lg:col-span-3 border-4 border-white/10 hover:border-secondary/50"
            />
          </div>
        </div>
              ...
              <div className="p-5 bg-primary/20 border border-primary/30">
                ...
                <div className="flex flex-wrap gap-2">
                  {sports.men.map((sport, i) => (
                    <Badge
                      key={i}
                      className="font-bold text-sm px-4 py-2 bg-primary text-white border-0"
                    >
                      {sport}
                    </Badge>
                  ))}
              ...
              <div className="p-5 bg-secondary/20 border border-secondary/30">
                ...
                <div className="flex flex-wrap gap-2">
                  {sports.women.map((sport, i) => (
                    <Badge
                      key={i}
                      className="font-bold text-sm px-4 py-2 bg-secondary text-white border-0"
                    >
                      {sport}
                    </Badge>
                  ))}
            ...
            <CardContent className="p-8 lg:p-10">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="text-center md:text-left">
                  <h3 className="text-2xl lg:text-3xl font-black mb-2 flex items-center gap-3 justify-center md:justify-start text-white uppercase tracking-wide">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-secondary text-white hover:bg-secondary/90 px-10 py-5 font-black text-lg shadow-xl hover:shadow-2xl transition-all whitespace-nowrap uppercase tracking-wide w-full md:w-auto justify-center"
                >
          ...
          <Card className="border-0 bg-white/5 backdrop-blur-sm">
            <CardContent className="p-8 lg:p-10">
              <div className="text-center">
                ...
                <h3 className="text-3xl lg:text-4xl font-black mb-4 text-white uppercase tracking-wide">
