...
export function CampusLifeSection() {
  ...
  return (
    <section
      id="campus-life"
      className="py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-10 sm:mb-16 lg:mb-20">
          <div className="inline-flex items-center gap-2 sm:gap-3 bg-primary/10 px-4 sm:px-8 py-2.5 sm:py-4 mb-4 sm:mb-8 border-2 border-primary/30">
            <Icons.heart className="w-4 h-4 sm:w-6 sm:h-6 text-primary" />
            <span className="text-xs sm:text-base font-black text-primary uppercase tracking-wide">
              Vibrant Community
            </span>
          </div>
          <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 sm:mb-8 text-primary tracking-tight">
        ...
        <div className="mb-10 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
          <Card className="border-2 border-primary/30 shadow-2xl overflow-hidden bg-white">
            <CardHeader className="bg-gradient-to-r from-primary via-primary to-secondary text-white p-5 sm:p-8 lg:p-10">
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                <div className="w-16 h-16 sm:w-24 sm:h-24 bg-white/20 backdrop-blur-sm flex items-center justify-center flex-shrink-0 shadow-xl">
                  <Icons.home className="w-8 h-8 sm:w-12 sm:h-12" />
                </div>
                <div className="text-center sm:text-left">
                  <CardTitle className="text-2xl sm:text-4xl md:text-5xl font-black mb-2 sm:mb-3 uppercase tracking-wide">
            ...
            <CardContent className="p-0">
              <div className="bg-gradient-to-br from-gray-100 to-gray-50 p-4 sm:p-6 lg:p-10 flex items-center justify-center">
                <div
                  className="relative w-full max-w-[280px] sm:max-w-md mx-auto shadow-2xl overflow-hidden border-4 border-white"
              ...
              <div className="p-4 sm:p-6 lg:p-10 bg-white">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                  <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 border-2 border-gray-200 hover:border-primary/30 transition-all">
                    <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center flex-shrink-0 shadow-lg">
                      <Icons.check className="w-5 h-5 sm:w-7 sm:h-7 text-white" />
                    </div>
                    <div>
                      <h4 className="font-black text-sm sm:text-lg mb-1 text-primary uppercase">Modern Amenities</h4>
                  ...
                  <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 border-2 border-gray-200 hover:border-primary/30 transition-all">
                    ...
                    <div>
                      <h4 className="font-black text-sm sm:text-lg mb-1 text-primary uppercase">Safe & Secure</h4>
                      <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                  ...
                  <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 border-2 border-gray-200 hover:border-primary/30 transition-all">
                    ...
                    <div>
                      <h4 className="font-black text-sm sm:text-lg mb-1 text-primary uppercase">Community Living</h4>
                      <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="mb-10 sm:mb-16 lg:mb-20">
          <div className="flex sm:grid sm:grid-cols-2 gap-4 sm:gap-6 overflow-x-auto sm:overflow-visible pb-4 sm:pb-0 snap-x-mandatory scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
            <img
              src="/images/img-0306.jpg"
              alt="Miles College dance team member performing in purple and gold"
              loading="lazy"
              className="w-[320px] sm:w-full h-72 sm:h-96 object-cover shadow-2xl hover:shadow-3xl sm:hover:-translate-y-2 transition-all duration-500 border-4 border-white flex-shrink-0 snap-start"
            />
            <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
          <Card className="border-2 border-gray-200 hover:border-primary/30 hover:shadow-2xl transition-all duration-500 bg-white">
            <CardHeader className="pb-3 sm:pb-4">
              <div className="flex items-center gap-3 sm:gap-4 mb-2">
                <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-lg">
                  <Icons.users className="w-5 h-5 sm:w-7 sm:h-7 text-white" />
                </div>
                <CardTitle className="text-lg sm:text-2xl font-black uppercase tracking-wide">
                  Student Organizations
                </CardTitle>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground">Join 80+ active clubs and organizations</p>
            </CardHeader>
            <CardContent>
              <div className="space-y-2 sm:space-y-3">
                {organizations.map((org, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 hover:bg-primary/5 transition-colors"
                  >
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gradient-to-br from-secondary to-secondary/70 flex-shrink-0" />
                    <span className="text-sm sm:text-base font-bold">{org}</span>
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          <div className="space-y-4 sm:space-y-6">
            <img
              ...
              loading="lazy"
              className="w-full h-56 sm:h-72 object-cover shadow-2xl hover:shadow-3xl sm:hover:-translate-y-2 transition-all duration-500 border-4 border-white"
            />
            <img
        ...
        <div className="mt-10 sm:mt-16 lg:mt-20 max-w-4xl mx-auto">
          <Card className="border-2 border-secondary/30 shadow-2xl bg-gradient-to-br from-secondary/5 to-white">
            <CardContent className="p-6 sm:p-8 lg:p-10">
              <div className="text-center">
                <div className="w-14 h-14 sm:w-20 sm:h-20 bg-gradient-to-br from-secondary to-secondary/80 flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-xl">
                  <Icons.calendar className="w-7 h-7 sm:w-10 sm:h-10 text-white" />
                </div>
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-3 sm:mb-4 text-secondary uppercase tracking-wide">
                  Experience Campus Life Firsthand
                </h3>
                <p className="text-muted-foreground text-base sm:text-xl mb-6 sm:mb-8 max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  <Button
                    asChild
                    size="lg"
                    className="bg-secondary hover:bg-secondary/90 text-white font-black px-6 sm:px-10 py-5 sm:py-6 text-base sm:text-lg shadow-xl hover:-translate-y-1 transition-all uppercase tracking-wide touch-target-lg"
                  >
                  ...
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="border-2 border-secondary text-secondary hover:bg-secondary hover:text-white font-black px-6 sm:px-10 py-5 sm:py-6 text-base sm:text-lg shadow-lg hover:-translate-y-1 transition-all uppercase tracking-wide bg-transparent touch-target-lg"
                  >
