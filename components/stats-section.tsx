    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 lg:mb-20">
          <p className="text-secondary font-black uppercase tracking-[0.3em] text-sm mb-6">
            BY THE NUMBERS
          </p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-16 lg:mb-20">
          {stats.map((stat, index) => {
            ...
            return (
              <Card
                key={index}
                className="relative p-6 lg:p-10 text-center bg-white/5 backdrop-blur-sm border-0 hover:bg-white/10 transition-all duration-500 group overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`w-16 lg:w-20 h-16 lg:h-20 mx-auto mb-6 lg:mb-8 bg-gradient-to-br ${stat.bgColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
            {highlights.map((highlight, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex items-center gap-4 lg:gap-5 p-5 lg:p-6 bg-white/5 backdrop-blur-sm border border-white/10 hover:border-secondary/50 transition-all duration-300 group"
                >
                  <div className="w-12 lg:w-14 h-12 lg:h-14 bg-gradient-to-br from-secondary/20 to-secondary/5 flex items-center justify-center flex-shrink-0 group-hover:from-secondary/30 group-hover:to-secondary/10 transition-all">
                    <IconComponent className="w-6 lg:w-7 h-6 lg:h-7 text-secondary" />
                  </div>
                  <p className="text-base lg:text-lg font-bold text-white">{highlight.text}</p>
                </div>
              )
            })}
          </div>
