...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#1a0a2e] via-[#2d1b4e] to-[#1a0a2e] text-white py-20 pb-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center space-y-10">
          <div>
            <h3 className="text-4xl md:text-5xl font-black mb-4 uppercase tracking-wide">
              Miles College
            </h3>
          ...
          <div className="py-10 border-y border-white/20">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-row flex-wrap justify-center items-center gap-6 text-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-black text-base">Admissions Office</span>
                </div>
                <a
                  href="tel:2059291657"
                  className="hover:text-secondary transition-colors font-black text-xl flex items-center justify-center min-h-[48px]"
                >
                  (205) 929-1657
                </a>
                ...
                <a
                  ...
                  className="hover:text-secondary transition-colors font-bold text-base flex items-center justify-center min-h-[48px]"
                >
          ...
          <div className="pt-8 border-t border-white/20">
            <p className="text-sm text-white/50 font-semibold">
              ...
              <span className="inline ml-1">Fairfield, Alabama</span>
            </p>
          </div>
        </div>
      </div>
